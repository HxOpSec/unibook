...
abstract final class AppStrings {
  static const Map<String, Map<String, String>> all = {
    'ru': {
      ...
      'searchByBooks': 'Книги',
      'searchByAuthors': 'Авторы',
      'searchByDepartments': 'Кафедры',
      'searchSuggestion': 'Введите запрос для поиска',
      'themeSettings': 'Тема и отображение',
      'cacheSettings': 'Кэш',
    ...
    'tj': {
      ...
      'searchByBooks': 'Китобҳо',
      'searchByAuthors': 'Муаллифон',
      'searchByDepartments': 'Кафедраҳо',
      'searchSuggestion': 'Барои ҷустуҷӯ дархост ворид кунед',
      'themeSettings': 'Мавзӯъ ва намоиш',
      'cacheSettings': 'Кэш',
      'clearCache': 'Тоза кардани кэш',
      'cacheCleared': 'Кэш тоза шуд',
      'aboutApp': 'Дар бораи барнома',
      'version': 'Версия',
      'privacyPolicy': 'Сиёсати махфият',
      'termsOfUse': 'Шартҳои истифода',
      'notificationSettings': 'Огоҳиҳо',
      'notificationsEnabled': 'Огоҳиҳо фаъол',
      'displaySettings': 'Танзимоти намоиш',
      'autoTheme': 'Авто',
    },
    'en': {
      'appName': 'DDMIT',
      ...
      'searchByDepartments': 'Departments',
      'searchSuggestion': 'Enter a query to search',
